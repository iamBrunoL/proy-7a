...
function Header()
{
    ...
    $this->Cell(40);
    // Título
    $this->Cell(90,10,'Reporte de consultas de los usuarios',0,0,'C');
    ...
    $this->Cell(20,6,'Nombre',1,0,'c',0);
    $this->Cell(50,6,'Email',1,0,'c',0);
    $this->Cell(30,6,'Telefono',1,0,'c',0);
    
    $this->Cell(28,6,'Nivel',1,1,'c',0);
}
...
while ($row = $query->fetch()){
  $pdf->Cell(10,16,$row['id'],1,0,'c',0);
  $pdf->Cell(20,16,$row['nombre'],1,0,'c',0);
  $pdf->Cell(50,16,$row['email'],1,0,'c',0);
  $pdf->Cell(30,16,$row['telefono'],1,0,'c',0);
  $pdf->Cell(28,16,$row['nivel'],1,1,'c',0);
}
$pdf->Output();
