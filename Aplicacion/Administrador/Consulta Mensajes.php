...
<div class="container-fluid bg-light position-relative shadow">
    ...
    <div class="container-fluid pt-5">
        ...
        method="POST">
            ...
            <input type="numero" class="form-control" name="numeroregistro" placeholder="Ingresa el número de registro del mensaje a buscar"/>
            <br>
            <input class="btn btn-secondary" type="submit" name="buscarNombre" value="Buscar número de registro">
            <input class="btn btn-secondary" type="submit" name="buscarTodo" value="Mostrar todos los mensajes">
            <br><br><br>
    </form>

    <?php
            $con = new PDO('mysql:host=192.168.0.105;dbname=canineworld','root','');
    ...
    ?>
                    <form action="../Reportes_PDF/reportesMensajes.php">
                         <button class="btn btn-primary py-2 px-4" >Generar PDF</button>
                    </form>
                    <form action="generarExcelMensajes.php">
                        <br>
